...
export default function SoftwareCTA() {
  return (
    <CTA
      ...
      description="
        Diseñamos y desarrollamos software alineado a objetivos de negocio:
        desde MVPs rápidos hasta sistemas empresariales listos para crecer.
        Sin improvisación. Sin plantillas. Tecnología que impulsa resultados.
      "
