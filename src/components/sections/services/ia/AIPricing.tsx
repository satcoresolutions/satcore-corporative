...
export default function AIPricing() {
  const plans = [
    ...
    {
      title: "Bots y workflows",
      price: "$1.000.000 - $3.500.000",
      time: "2-4 semanas promedio",
    },
    {
      title: "Web scraping / Integraciones",
      price: "$1.500.000 - $6.000.000",
      time: "2-6 semanas promedio",
    },
    {
    ...
    <Section variant="dark" paddingY="lg" overflow>
      ...
      >
        <h2 className="text-3xl md:text-5xl font-bold mb-4">
          Tarifas de automatización e IA
        </h2>

        <p className="text-(--color-muted-light) max-w-2xl mx-auto">
          Inversión estimada según complejidad, integraciones y nivel de inteligencia requerido. Cada solución es personalizada.
        </p>
      </motion.div>
