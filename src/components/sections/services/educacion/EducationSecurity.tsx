...
const includes = [
    "Clases en vivo o modalidad on-demand",
    "Material didáctico (presentaciones y guías)",
    "Laboratorios prácticos y ejercicios aplicados",
    "Acceso a grabaciones (según modalidad)",
...
const notIncludes = [
    ...
    "Licencias de software externas",
    "Certificaciones oficiales (voucher)",
    "Transporte o alojamiento (presencial)",
    "Servicios fuera del alcance del curso",
];
...
export default function EducationScope() {
    return (
        <Section variant="blue" paddingY="lg">
            ...
            >
                ...
                <p className="text-(--color-muted-light) max-w-2xl mx-auto">
                    Definimos claramente qué incluye cada programa y sus condiciones.
                </p>
            </motion.div>
