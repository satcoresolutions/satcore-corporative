...
export default function EducationServiceCatalog() {
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-muted max-w-2xl mx-auto">
                        Cursos diseñados para desarrollar habilidades reales en tecnología.
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    {servicesRegistry.education.map((category, index) => (
                        <motion.div
                            key={category.id}
                            variants={item}
                            className="h-full"
                            ...
                            <div
                                onClick={() => {
                                    ...
                                    pushEvent({
                                        ...
                                        service_category: "education", // 🔥 cambio clave
                                        position: index + 1,
