...
export default function MarketingServiceCatalog() {
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-bold mb-4">
                        Servicios de marketing y diseño que ofrecemos
                    </h2>

                    <p className="text-muted max-w-2xl mx-auto">
                        Estrategias, diseño y ejecución digital para potenciar tu marca.
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                >
                    {servicesRegistry.marketing.map((category, index) => (
                        <motion.div
                            key={category.id}
                            variants={item}
                            className="h-full"
