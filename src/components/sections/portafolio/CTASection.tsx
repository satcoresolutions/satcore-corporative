...
export default function PortfolioCTA() {
  return (
    <CTA
      ...
      description="
        Hemos ayudado a empresas a construir soluciones digitales que generan
        resultados. Cuéntanos tu idea y diseñemos una solución a tu medida,
        alineada a tus objetivos y lista para escalar.
      "
